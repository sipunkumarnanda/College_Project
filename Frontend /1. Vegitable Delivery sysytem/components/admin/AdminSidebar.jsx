...
import { HomeIcon, ShieldCheckIcon, StoreIcon, TicketPercentIcon, MessageSquareWarningIcon } from "lucide-react"
...
const AdminSidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { name: 'User Complaints', href: '/admin/complaints', icon: MessageSquareWarningIcon },
    ...
    return (
        <div className="inline-flex h-full flex-col gap-5 border-r border-slate-200 sm:min-w-60">
            <div className="flex flex-col gap-3 justify-center items-center pt-8 max-sm:hidden">
                ...
                <p className="text-slate-700">Hi, Sipun Kumar</p>
            </div>
